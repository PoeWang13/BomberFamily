...
public class Bomb_Clock : Bomb_Base
{
    ...
    public override void Bombed()
    {
        ...
        // Sağ
        for (int e = 1; e < BombLimit + 1 && canGoRight; e++)
        {
            ...
            // Bomb Fire bırak
            BombFirePool.HavuzdanObjeIste(new Vector3Int(MyCoor.x + e, 0, MyCoor.y)).GetComponent<Bomb_Fire>().SetFire(BombPower, BombFireTime);
            // Bir obje var mı
        ...
        for (int e = 1; e < MyOwner.CharacterStat.myBombFireLimit + 1 && canGoForward; e++)
        {
            ...
            // Bomb Fire bırak
            BombFirePool.HavuzdanObjeIste(new Vector3Int(MyCoor.x, 0, MyCoor.y + e)).GetComponent<Bomb_Fire>().SetFire(BombPower, BombFireTime);
            // Bir obje var mı
